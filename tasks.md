...
- [ ] **Tarea 4: Botones flotantes del feed.**
...
- [ ] **Tarea 6: Formulario de Registro/Login con validación.**
...
- [ ] **Tarea 7: Integrar fricción en los botones del feed.**
  - Acción: modificar los botones de la Tarea 4: sin sesión, "Me gusta"/"Comentar" abren el modal de Auth (Tarea 6) en vez de ejecutar la acción.
...
- [ ] **Tarea 9: Bandeja de Entrada (Inbox) con estados de carga/vacío.**
  - Acción: construir la lista de notificaciones mock en `app/inbox.tsx`, con `LoadingState`/`EmptyState` igual que el Feed.
  - Verificación: la pestaña Bandeja muestra las notificaciones simuladas o, si el mock está vacío, el mensaje de estado vacío.
- [ ] **Tarea 10: Chat 1 a 1.**
...
- [ ] **Tarea 12: Pantalla de Detalle de Video (listado → detalle).**
...
- [ ] **Tarea 13: Formulario de Publicar Video con validación.**
